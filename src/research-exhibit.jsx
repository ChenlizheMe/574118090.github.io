...
const selection = [
  { id:'skillforge', shortTitle:'SkillForge', subject:'NeurIPS 2026 Main Track', field:'AI AGENTS' },
...
export function ResearchExhibit({lang}) {
 ...
 const papers=selection.map(meta=>({...publications.find(p=>p.image.startsWith(`/img/papers/${meta.id}.`)),...meta}));
